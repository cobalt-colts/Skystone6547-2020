 ...
 */
@Autonomous(name = "RED one skystone inside")
@Disabled
public class RedOneSkystoneInside extends SkyStone6547Meet2 {
    ...
    public void runOpMode()
    {
        ...
        DriveFieldRealtiveDistance(.5, 270, 1.65); //drive away from stone
        TurnPID(270,1); //align to stones
        //setGrabber(1);
        sleep(.5);
