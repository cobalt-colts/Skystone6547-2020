 ...
 */
@Autonomous(name = "BLUE one skystone inside")
@Disabled
public class BlueOneSkystoneInside extends SkyStone6547 {
    ...
    public void runOpMode()
    {
        ...
        setGrabber(1);
        sleep(.5);
        DriveFieldRealtiveDistance(.5,180,distanceToDrive); //other side
        // setLiftLevel(1);
