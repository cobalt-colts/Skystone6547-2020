 ...
 */
@Config
public class StandardTwowheelLocalizerState extends TwoTrackingWheelLocalizer {
    ...
    public StandardTwowheelLocalizerState(HardwareMap hardwareMap, DriveTrain6547State bot) {
        super(Arrays.asList(
