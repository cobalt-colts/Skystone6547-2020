...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalEncoderName = "v", horizontalEncoderName = "lb";

    @Override
    public void runOpMode() throws InterruptedException {

        //Assign the hardware map to the odometry wheels
        vertical = hardwareMap.dcMotor.get(verticalEncoderName);
        ...
        */
        ...
        OdometryGlobalCoordinatePosition globalPositionUpdate = new OdometryGlobalCoordinatePosition(vertical, horizontal, COUNTS_PER_INCH, 75);
